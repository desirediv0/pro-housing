      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
        <div className="bg-white/95 backdrop-blur-lg border-t border-gray-200/50 shadow-2xl">
          <div className="grid grid-cols-5 gap-1 px-2 py-2">
            ...
            <button
              onClick={handleWhatsAppClick}
              className="flex flex-col items-center justify-center p-3 text-gray-600 hover:text-green-600 transition-all duration-300"
            >
              <svg
            ...
            <button
              onClick={() =>
                window.open(
                  "https://www.youtube.com/@PROHOUSINGINDIA",
                  "_blank"
                )
              }
              className="flex flex-col items-center justify-center p-3 text-gray-600 hover:text-red-600 transition-all duration-300"
            >
              <svg
                className="h-5 w-5 mb-1"
                viewBox="0 0 24 24"
