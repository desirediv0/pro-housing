    ...
    <div className={`relative ${className}`}>
      ...
      <div className="flex items-center space-x-2">
        ...
        {!showDropdown && (
          <button
            onClick={() => setShowAllUnits(!showAllUnits)}
            className="p-2 text-gray-400 hover:text-[#5e4cbb] hover:bg-[#5e4cbb]/5 rounded-lg transition-all duration-200"
      ...
      <AnimatePresence>
        {showAllUnits && !showDropdown && (
          <motion.div
            ...
            className="mt-3 p-4 bg-gradient-to-br from-[#5e4cbb]/5 to-blue-50 rounded-xl border border-[#5e4cbb]/10"
          >
              ...
              {popularUnits.map((unit) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`p-3 bg-white rounded-lg border transition-all duration-200 ${
                      selectedUnit === unit
