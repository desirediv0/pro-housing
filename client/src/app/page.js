    ...
    <div className="min-h-screen bg-white">
      <div className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="hidden sm:flex">
                      {[
                        ...
                        <button
                          ...
                          className={`flex-1 flex items-center justify-center py-2.5 px-3 rounded-lg font-bold transition-all duration-300 text-sm ${listingType === tab.key ||
                    ...
                    <div className="hidden sm:flex flex-wrap gap-1.5 sm:gap-2">
                      {[
                        ...
                        <button
                          ...
                          className={`px-3 sm:px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300 text-sm font-medium border ${priceRange === range.value
        ...
        <button
          ...
          className="hidden absolute left-4 top-1/4 md:top-1/2 transform -translate-y-1/2 z-20 w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full md:flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300"
        >
        ...
        <button
          ...
          className="hidden absolute right-4 top-1/4 md:top-1/2 transform -translate-y-1/2 z-20 w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full md:flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300"
        >
                ...
                <div className="flex space-x-2">
                  {[
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center px-4 py-3 rounded-xl transition-all duration-300 group min-w-[120px] ${activeCategory === category.key
                          ? "bg-[#1A3B4C] text-white"
                          : "hover:bg-[#1A3B4C] hover:text-white"
                        }`}
                    >
                      <category.icon
                        className={`h-6 w-6 mb-2 transition-colors ${activeCategory === category.key
                            ? "text-white"
                            : "text-[#1A3B4C] group-hover:text-white"
                          }`}
                      />
                      <span
                        className={`text-sm font-semibold transition-colors ${activeCategory === category.key
                            ? "text-white"
                      ...
                      <span
                        className={`text-xs transition-colors ${activeCategory === category.key
                            ? "text-white/80"
