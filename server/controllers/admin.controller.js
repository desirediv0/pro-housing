...
export const createAdmin = asyncHandler(async (req, res) => {
    ...
    res.status(201).json(
        new ApiResponsive(201, admin, "Admin account created successfully")
    );
});
...
export const logoutAdmin = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(
        new ApiResponsive(200, null, "Admin logged out successfully")
    );
});
...
export const changeAdminPassword = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(
        new ApiResponsive(200, null, "Password changed successfully")
    );
});
...
export const deleteAdmin = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(
        new ApiResponsive(200, null, "Admin account deleted successfully")
    );
});
